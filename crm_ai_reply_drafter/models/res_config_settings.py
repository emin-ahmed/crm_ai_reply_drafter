...
class ResConfigSettings(models.TransientModel):
    ...
    crm_ai_provider = fields.Selection(
        ...
        string='LLM Provider',
        default='anthropic',
        config_parameter='crm_ai_reply_drafter.provider',
    ...
    crm_ai_openai_api_key = fields.Char(
        ...
        config_parameter='crm_ai_reply_drafter.openai_api_key',
    ...
    crm_ai_openai_base_url = fields.Char(
        ...
        config_parameter='crm_ai_reply_drafter.openai_base_url',
    ...
    crm_ai_ollama_base_url = fields.Char(
        ...
        config_parameter='crm_ai_reply_drafter.ollama_base_url',
    ...
    crm_ai_system_prompt = fields.Char(
        ...
        config_parameter='crm_ai_reply_drafter.system_prompt',
    ...
    crm_ai_max_context_messages = fields.Integer(
        ...
        default=20,
        config_parameter='crm_ai_reply_drafter.max_context_messages',
