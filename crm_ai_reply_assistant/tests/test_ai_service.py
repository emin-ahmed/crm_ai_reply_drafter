...
from odoo.addons.crm_ai_reply_assistant.services import providers
...
class TestAiReplyService(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.ICP.set_param('crm_ai_reply_assistant.provider', 'anthropic')
        cls.ICP.set_param('crm_ai_reply_assistant.model', 'claude-opus-4-8')
        cls.ICP.set_param('crm_ai_reply_assistant.anthropic_api_key', 'sk-ant-test')
        cls.ICP.set_param('crm_ai_reply_assistant.system_prompt', 'You are a sales rep.')
        cls.ICP.set_param('crm_ai_reply_assistant.max_context_messages', '20')
    ...
    def test_max_context_messages_limits_conversation(self):
        self.ICP.set_param('crm_ai_reply_assistant.max_context_messages', '1')
        _system, user = self.service.build_prompt(self.lead)
    ...
    def test_prepare_requires_api_key(self):
        self.ICP.set_param('crm_ai_reply_assistant.anthropic_api_key', '')
        with self.assertRaises(UserError):
            self.service.prepare(self.lead)

    def test_get_provider_unknown_raises(self):
        self.ICP.set_param('crm_ai_reply_assistant.provider', 'nope')
        with self.assertRaises(UserError):
    ...
    def test_openai_compatible_base_url_is_passed(self):
        ...
        self.ICP.set_param('crm_ai_reply_assistant.provider', 'openai')
        self.ICP.set_param('crm_ai_reply_assistant.openai_api_key', 'sk-or-test')
        self.ICP.set_param('crm_ai_reply_assistant.openai_base_url',
                           'https://openrouter.ai/api/v1')
        self.ICP.set_param('crm_ai_reply_assistant.model',
